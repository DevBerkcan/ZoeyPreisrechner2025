import { GenderPricingData } from "./types/types";

export const pricingData: GenderPricingData = {
  Frau: {
    Haarentfernung: {
      Kopf: [
        {
      ...
      Oberkörper: [
        ...
        },
        {
          ...
          pricing: {
            "ab 5 Areale": 98,
            "ab 3 Areale": 111,
            "Einzelpreis pro Behandlung": 131,
          },
        },
        {
          id: 13,
        ...
        },
        {
          ...
          pricing: {
            "ab 5 Areale": 80,
            "ab 3 Areale": 91,
            "Einzelpreis pro Behandlung": 107,
          },
        },
        {
          id: 18,
